...
def batch_generator(lines, batch_size, is_training):
    """
    ...
    while True:
        i = 0
        for index in np.random.permutation(len(lines)):
            center, left, right, steering_angle = lines[index][:4]
